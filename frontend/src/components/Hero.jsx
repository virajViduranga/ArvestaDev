...
export default function Hero() {
  return (
    <section
      ...
      style={{ backgroundImage: 'url("/bg02.webp")', backgroundRepeat: 'repeat' }}
    >
  ...
  return (
    <div className="max-w-2xl lg:max-w-none">
      ...
      <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl xl:text-6xl text-balance">
        ...
        <span className="text-[var(--color-primary)]">Built to Get Things Done.</span>
      </h1>

      {/* Description */}
      <p className="mt-6 text-lg leading-8 text-white text-balance">
        ArvestaDev brings practical developer, productivity, file, and text tools together in one fast, simple place. No installations or clutter—just high-quality utilities ready when you need them.
      </p>
      ...
      <div className="mt-8 flex flex-col sm:flex-row items-center sm:items-center gap-4">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center border border-[var(--color-border)] bg-[var(--color-surface)] px-6 py-3.5 text-base font-semibold text-[var(--color-text-primary)] hover:border-[var(--color-primary)] hover:bg-[var(--color-secondary)] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:ring-offset-2 focus:ring-offset-[var(--color-background)]"
        >
      ...
      <ul className="flex flex-col sm:flex-row sm:flex-wrap gap-y-3 gap-x-6">
        {benefits.map((benefit, index) => (
          <li key={index} className="flex items-center text-sm font-medium text-white">
            <svg className="mr-2 h-5 w-5 text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div className="relative rounded-2xl border border-white/20 bg-white/5 backdrop-blur-md shadow-2xl transition-colors duration-300 overflow-hidden group">
        ...
        <div className="flex h-72 sm:h-80 w-full bg-transparent">
          ...
          <div className="hidden sm:flex w-1/3 flex-col border-r border-white/10 bg-white/5 p-3 space-y-2">
            <div className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-2 px-2 mt-1">Categories</div>
          ...
          <div className="flex-1 flex flex-col relative">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-2 bg-white/5">
              <span className="text-xs font-medium text-gray-300">input.json</span>
              <button className="text-xs rounded bg-[var(--color-primary)] px-2 py-1 text-white hover:opacity-80 transition-opacity">Format</button>
            </div>

            {/* Editor Content */}
            <div className="p-4 font-mono text-sm leading-relaxed overflow-hidden text-gray-200">
              <span className="text-yellow-400">{`{`}</span><br />
              &nbsp;&nbsp;<span className="text-blue-400">"app"</span>: <span className="text-green-400">"ArvestaDev"</span>,<br />
              &nbsp;&nbsp;<span className="text-blue-400">"status"</span>: <span className="text-green-400">"online"</span>,<br />
              &nbsp;&nbsp;<span className="text-blue-400">"features"</span>: <span className="text-yellow-400">{`[`}</span><br />
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-green-400">"Fast"</span>,<br />
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-green-400">"Secure"</span>,<br />
              &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-green-400">"Developer-friendly"</span><br />
              &nbsp;&nbsp;<span className="text-yellow-400">{`]`}</span><br />
