...
export default function ToolSeoSection({ steps, faqs }) {
  return (
    <div className="max-w-6xl mx-auto mt-20 pt-10 border-t border-[var(--color-border)]">
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-16">
          {steps.map((step, index) => (
            <div key={index} className="bg-[var(--color-surface)] p-5 rounded-lg border-l-4 border-[var(--color-primary)] shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all cursor-pointer">
